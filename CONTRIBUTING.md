...
This document briefly describes how to contribute to the [Spectral Library Format](https://github.com/HUPO-PSI/SpectralLibraryFormat).

## Before you Begin

If you have an idea for a feature, use case to add or an approach for a bugfix, it is best to communicate with the community by
[psi-ms-dev email](mailto:psidev-ms-dev@lists.sourceforge.net) or create an issue
in [GitHub issues](https://github.com/HUPO-PSI/SpectralLibraryFormat/issues).

## How to Contribute

* All changes to the [Spectral Library Specification](https://github.com/HUPO-PSI/SpectralLibraryFormat/tree/master/specification)
  should be made through pull requests to this repository (with just two exceptions outlined below).
...
* Fork the [Spectral Library Format repository](https://github.com/HUPO-PSI/SpectralLibraryFormat) on
...
The [Spectral Library Format](https://github.com/HUPO-PSI/SpectralLibraryFormat/) is filled with comments and ideas
...
than the author of the pull request. A member of the committer group merging a
...
The Spectral Library Format *committers* group may only commit directly to the
repository (i.e.  outside of a pull request and not following the procedures described here)
